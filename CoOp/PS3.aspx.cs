...
namespace CoOp
{
    public partial class PS3 : System.Web.UI.Page
    {
        ...
        {
            GridView1.DataSource = db.getPSGames(5, 1);
            GridView1.DataBind();
            Panel1.Visible = true;
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                case "Nieistotne":
                    GridView1.DataSource = db.getPSGames(5, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "Internet":
                    GridView1.DataSource = db.filterInternetGames(5, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "LAN":
                    GridView1.DataSource = db.filterLANGames(5, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "Split":
                    GridView1.DataSource = db.filterSPLITGames(5, int.Parse(DropDownList2.SelectedValue));
                    break;
            }
            GridView1.DataBind();
        }
