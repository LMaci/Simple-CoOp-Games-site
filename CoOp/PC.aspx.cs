...
namespace CoOp
{
    public partial class _Default : Page
    {
        ...
        {
            GridView1.DataSource = db.getPCGames(1);
            GridView1.DataBind();
            Panel1.Visible = true;
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (gra.OBRAZEK != null)
                Image1.ImageUrl = "\\IMG\\" + gra.OBRAZEK;
            else Image1.ImageUrl = "\\IMG\\NoPic.png";
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                case "Nieistotne":
                    GridView1.DataSource = db.getPCGames(int.Parse(DropDownList2.SelectedValue));
                    break;

                case "Internet":
                    GridView1.DataSource = db.filterInternetGames(2, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "LAN":
                    GridView1.DataSource = db.filterLANGames(2, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "Split":
                    GridView1.DataSource = db.filterSPLITGames(2, int.Parse(DropDownList2.SelectedValue));
                    break;
            }
            GridView1.DataBind();
        }
