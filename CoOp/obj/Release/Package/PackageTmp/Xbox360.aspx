<%@ Page Title ="XBOX-360" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Xbox360.aspx.cs" Inherits="CoOp.Xbox360" %>
                            ...
                            <table class="nav-justified">
                                <tr>
                                    <td class="auto-style17" rowspan="5">
                                        <asp:Image ID="Image1" runat="server" Height="208px" ImageUrl="http://meeconline.com/wp-content/uploads/2014/08/placeholder.png" Width="208px" />
                                    </td>
