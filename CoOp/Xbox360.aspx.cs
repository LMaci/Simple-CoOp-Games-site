...
namespace CoOp
{
    public partial class Xbox360 : System.Web.UI.Page
    {
        ...
        {
            GridView1.DataSource = db.getXboxGames(3,1);
            GridView1.DataBind();
            Panel1.Visible = true;
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                case "Nieistotne":
                    GridView1.DataSource = db.getXboxGames(3, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "Internet":
                    GridView1.DataSource = db.filterInternetGames(3, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "LAN":
                    GridView1.DataSource = db.filterLANGames(3, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "Split":
                    GridView1.DataSource = db.filterSPLITGames(3, int.Parse(DropDownList2.SelectedValue));
                    break;
            }
            GridView1.DataBind();
        }
