...
namespace CoOp
{
    public partial class PS4 : System.Web.UI.Page
    {
        ...
        {
            GridView1.DataSource = db.getPSGames(6, 1);
            GridView1.DataBind();
            Panel1.Visible = true;
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                case "Nieistotne":
                    GridView1.DataSource = db.getPSGames(6, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "Internet":
                    GridView1.DataSource = db.filterInternetGames(6, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "LAN":
                    GridView1.DataSource = db.filterLANGames(6, int.Parse(DropDownList2.SelectedValue));
                    break;

                case "Split":
                    GridView1.DataSource = db.filterSPLITGames(6, int.Parse(DropDownList2.SelectedValue));
                    break;
            }
            GridView1.DataBind();
        }
